...
from adapters.git import check_pull_request_commits
# rename that shit.
...
class DCOPullListener(object):
    def __init__(self):
        pass

    def event_fired(self, content):
        number = content.get('pull_request').get('number')
        check_pull_request_commits(number)
